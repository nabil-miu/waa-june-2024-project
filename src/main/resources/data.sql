...
-- ResourceCategory
INSERT INTO resource_category (name, description, parent_id, deleted)
VALUES ('Electronics', 'Category for electronic items', NULL, false);
INSERT INTO resource_category (name, description, parent_id)
VALUES ('Computers', 'Category for computers and accessories', 1, false);
INSERT INTO resource_category (name, description, parent_id)
VALUES ('Laptops', 'Subcategory for laptops', 2, false);
INSERT INTO resource_category (name, description, parent_id)
VALUES ('Smartphones', 'Category for smartphones', 1, false);
INSERT INTO resource_category (name, description, parent_id)
VALUES ('Gaming Consoles', 'Category for gaming consoles', 1, false);
