...
INSERT INTO student_directory (id, user_id, contact_information, academic_year, major)
VALUES
    (1, 1, 'johndoe@university.edu', '2023-09-01', 'Software Engineering'),
    (2, 2, 'janesmith@university.edu', '2022-09-01', 'Fine Arts');
-- User Activities
